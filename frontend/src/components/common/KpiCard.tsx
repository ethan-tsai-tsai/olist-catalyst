...
interface KpiCardProps {
  ...
  children: ReactNode; // For the icon
}

const KpiCard: React.FC<KpiCardProps> = ({ title, value, change, changeType, children }) => {
        ...
        {change && (
          <span
            className={`flex items-center gap-1 text-sm font-medium ${
              isIncrease ? 'text-meta-3' : ''
            } ${isDecrease ? 'text-meta-5' : ''} `}
          >
            {change}
            {isIncrease && (
            ...
            {isDecrease && (
                <svg className="fill-meta-5" width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.64284 7.69237L9.09102 4.33987L10 5.22362L5 10.0849L0 5.22362L0.908973 4.33987L4.35716 7.69237L4.35716 0.0848689L5.64284 0.0848689L5.64284 7.69237Z" fill=""/>
                </svg>
            )}
          </span>
        )}
